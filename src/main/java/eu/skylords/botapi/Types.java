...
public class Types {
    ...
    public static class MapInfo {
        ...
        public void setMap(Maps v) {
            this.map = v;
        }

        public CommunityMapInfo getCommunityMapDetails() {
            return community_map_details;
        }

        public void setCommunityMapDetails(CommunityMapInfo v) {
            this.community_map_details = v;
        }
    ...
    public static class Deck {
        ...
        public byte getCoverCardIndex() {
            return cover_card_index;
        }

        public void setCoverCardIndex(byte v) {
            this.cover_card_index = v;
        }

        public CardId[/*size=20*/] getCards() {
            return cards;
        }

        public void setCards(CardId[/*size=20*/] v) {
            this.cards = v;
        }
    ...
    public static final class AbilityEffectSpecificDamageRadialArea implements AbilityEffectSpecific {
        ...
        @Override
        @JsonIgnore
        public AbilityEffectSpecificType getType() {
            return AbilityEffectSpecificType.DamageRadialArea;
        }
        ...
        public void setProgressCurrent(float v) {
            this.progress_current = v;
        }
        ...
        public void setProgressDelta(float v) {
            this.progress_delta = v;
        }
        ...
        public void setDamageRemaining(float v) {
            this.damage_remaining = v;
        }

        public AbilityEffectSpecificDamageRadialArea() {
        }

        public AbilityEffectSpecificDamageRadialArea(float progress_current, float progress_delta, float damage_remaining) {
    ...
    public static final class AbilityEffectSpecificDamageOverTime implements AbilityEffectSpecific {
        ...
        @JsonIgnore
        public AbilityEffectSpecificType getType() {
            return AbilityEffectSpecificType.DamageOverTime;
        }

        public TickCount getTickWaitDuration() {
            return tick_wait_duration;
        }

        public void setTickWaitDuration(TickCount v) {
            this.tick_wait_duration = v;
        }
        ...
        public void setTicksLeft(TickCount v) {
            this.ticks_left = v;
        }
        ...
        public void setTickDamage(float v) {
            this.tick_damage = v;
        }
    ...
    public static final class AbilityEffectSpecificLinkedFire implements AbilityEffectSpecific {
        ...
        @JsonIgnore
        public AbilityEffectSpecificType getType() {
            return AbilityEffectSpecificType.LinkedFire;
        }
        ...
        public void setFighting(boolean v) {
            this.fighting = v;
        }
        ...
        public void setSupportCap(short v) {
            this.support_cap = v;
        }

        public byte getSupportProduction() {
            return support_production;
        }

        public void setSupportProduction(byte v) {
            this.support_production = v;
        }
    ...
    public static final class AbilityEffectSpecificOther implements AbilityEffectSpecific {
        ...
        @JsonIgnore
        public AbilityEffectSpecificType getType() {
            return AbilityEffectSpecificType.Other;
        }
    ...
    public static class AbilityEffectSpecificHolder {
        ...
        public AbilityEffectSpecificHolder(AbilityEffectSpecific v) {
            ...
            switch (v.getType()) {
                case AbilityEffectSpecificType.DamageRadialArea:
                    this.damageRadialArea = (AbilityEffectSpecificDamageRadialArea) v;
                    break;
                ...
                case AbilityEffectSpecificType.Other:
                    ...
                    break;
                default:
                    throw new IllegalArgumentException("Unknown AbilityEffectSpecific " + v.getType());
            }
        }
    ...
    public static class AbilityEffect {
        ...
        public void setLine(AbilityLine v) {
            this.line = v;
        }
        ...
        public void setSource(EntityId v) {
            this.source = v;
        }
        ...
        public void setSourceTeam(byte v) {
            this.source_team = v;
        }
        ...
        public void setStartTick(Tick v) {
            this.start_tick = v;
        }
        ...
        public void setSpecific(AbilityEffectSpecificHolder v) {
            this.specific = v;
        }
    ...
    public static final class AspectPowerProduction implements Aspect {
        ...
        public void setCurrentPower(float v) {
            this.current_power = v;
        }
        ...
        public void setPowerCapacity(float v) {
            this.power_capacity = v;
        }
    ...
    public static final class AspectHealth implements Aspect {
        ...
        public void setCurrentHp(float v) {
            this.current_hp = v;
        }

        public float getCapCurrentMax() {
            return cap_current_max;
        }

        public void setCapCurrentMax(float v) {
            this.cap_current_max = v;
        }
    ...
    public static final class AspectModeChange implements Aspect {
        ...
        public void setCurrentMode(ModeId v) {
            this.current_mode = v;
        }

        public ModeId[] getAllModes() {
            return all_modes;
        }

        public void setAllModes(ModeId[] v) {
            this.all_modes = v;
        }
    ...
    public static final class AspectConstructionData implements Aspect {
        ...
        public TickCount getRefreshCountRemaining() {
            return refresh_count_remaining;
        }

        public void setRefreshCountRemaining(TickCount v) {
            this.refresh_count_remaining = v;
        }

        public TickCount getRefreshCountTotal() {
            return refresh_count_total;
        }

        public void setRefreshCountTotal(TickCount v) {
            this.refresh_count_total = v;
        }

        public float getHealthPerBuildUpdateTrigger() {
            return health_per_build_update_trigger;
        }

        public void setHealthPerBuildUpdateTrigger(float v) {
            this.health_per_build_update_trigger = v;
        }

        public float getRemainingHealthToAdd() {
            return remaining_health_to_add;
        }

        public void setRemainingHealthToAdd(float v) {
            this.remaining_health_to_add = v;
        }
        ...
        public AspectHolder(Aspect v) {
            ...
            switch (v.getType()) {
                ...
                case AspectType.Roam:
                    ...
                    break;
                default:
                    throw new IllegalArgumentException("Unknown Aspect " + v.getType());
            }
        }
    ...
    public static class Orbs {
        ...
        public void setStarting(byte v) {
            this.starting = v;
        }
    ...
    public static class PlayerEntity {
        ...
        public void setEffects(AbilityEffect[] v) {
            this.effects = v;
        }

        public AspectHolder[] getAspects() {
            return aspects;
        }

        public void setAspects(AspectHolder[] v) {
            this.aspects = v;
        }
        ...
        public void setVoidPower(float v) {
            this.void_power = v;
        }

        public short getPopulationCount() {
            return population_count;
        }

        public void setPopulationCount(short v) {
            this.population_count = v;
        }
    ...
    public static class MatchPlayer {
        ...
        public void setEntity(PlayerEntity v) {
            this.entity = v;
        }
    ...
    public static final class SingleTargetSingleEntity implements SingleTarget {
        ...
        public SingleTargetType getType() {
            return SingleTargetType.SingleEntity;
        }
    ...
    public static final class SingleTargetLocation implements SingleTarget {
        ...
        public void setXy(Position2D v) {
            this.xy = v;
        }
        ...
        public SingleTargetHolder(SingleTarget v) {
            ...
            switch (v.getType()) {
                ...
                case SingleTargetType.Location:
                    ...
                    break;
                default:
                    throw new IllegalArgumentException("Unknown SingleTarget " + v.getType());
            }
        }
    ...
    public static final class TargetSingle implements Target {
        ...
        public void setSingle(SingleTargetHolder v) {
            this.single = v;
        }
    ...
    public static final class TargetMulti implements Target {
        ...
        public void setXyBegin(Position2D v) {
            this.xy_begin = v;
        }
        ...
        public void setXyEnd(Position2D v) {
            this.xy_end = v;
        }
        ...
        public TargetHolder(Target v) {
            ...
            switch (v.getType()) {
                ...
                case TargetType.Multi:
                    ...
                    break;
                default:
                    throw new IllegalArgumentException("Unknown Target " + v.getType());
            }
        }
    ...
    public static final class JobGoto implements Job {
        ...
        public Position2DWithOrientation[] getWaypoints() {
            return waypoints;
        }

        public void setWaypoints(Position2DWithOrientation[] v) {
            this.waypoints = v;
        }
        ...
        public void setTargetEntityId(EntityId v) {
            this.target_entity_id = v;
        }
        ...
        public void setWalkMode(WalkMode v) {
            this.walk_mode = v;
        }
    ...
    public static final class JobAttackMelee implements Job {
        ...
        public void setTarget(TargetHolder v) {
            this.target = v;
        }

        public boolean getUseForceGoto() {
            return use_force_goto;
        }

        public void setUseForceGoto(boolean v) {
            this.use_force_goto = v;
        }
        ...
        public void setNoMove(boolean v) {
            this.no_move = v;
        }
        ...
        public void setTooCloseRange(float v) {
            this.too_close_range = v;
        }
    ...
    public static final class JobCastSpell implements Job {
        ...
        public void setSpellId(SpellId v) {
            this.spell_id = v;
        }
    ...
    public static final class JobTalk implements Job {
        ...
        public void setTarget(EntityId v) {
            this.target = v;
        }

        public boolean getWalkToTarget() {
            return walk_to_target;
        }

        public void setWalkToTarget(boolean v) {
            this.walk_to_target = v;
        }
    ...
    public static final class JobScriptTalk implements Job {
        ...
        public boolean getHideWeapon() {
            return hide_weapon;
        }

        public void setHideWeapon(boolean v) {
            this.hide_weapon = v;
        }
    ...
    public static final class JobFreeze implements Job {
        ...
        public TickCount getDuration() {
            return duration;
        }

        public void setDuration(TickCount v) {
            this.duration = v;
        }

        public TickCount getDelayAbility() {
            return delay_ability;
        }

        public void setDelayAbility(TickCount v) {
            this.delay_ability = v;
        }

        public AbilityId[] getAbilityIdWhileFrozen() {
            return ability_id_while_frozen;
        }

        public void setAbilityIdWhileFrozen(AbilityId[] v) {
            this.ability_id_while_frozen = v;
        }

        public AbilityId[] getAbilityIdDelayed() {
            return ability_id_delayed;
        }

        public void setAbilityIdDelayed(AbilityId[] v) {
            this.ability_id_delayed = v;
        }

        public AbilityLine getAbilityLineIdCancelOnStart() {
            return ability_line_id_cancel_on_start;
        }

        public void setAbilityLineIdCancelOnStart(AbilityLine v) {
            this.ability_line_id_cancel_on_start = v;
        }

        public boolean getPushbackImmunity() {
            return pushback_immunity;
        }

        public void setPushbackImmunity(boolean v) {
            this.pushback_immunity = v;
        }
    ...
    public static final class JobAttackSquad implements Job {
        ...
        public void setWeaponType(byte v) {
            this.weapon_type = v;
        }
        ...
        public SpellId getAttackSpell() {
            return attack_spell;
        }

        public void setAttackSpell(SpellId v) {
            this.attack_spell = v;
        }
        ...
        public void setOperationRange(float v) {
            this.operation_range = v;
        }
        ...
        public boolean getWasInAttack() {
            return was_in_attack;
        }

        public void setWasInAttack(boolean v) {
            this.was_in_attack = v;
        }
    ...
    public static final class JobCastSpellSquad implements Job {
        ...
        public boolean getSpellFired() {
            return spell_fired;
        }

        public void setSpellFired(boolean v) {
            this.spell_fired = v;
        }

        public boolean getSpellPerSourceEntity() {
            return spell_per_source_entity;
        }

        public void setSpellPerSourceEntity(boolean v) {
            this.spell_per_source_entity = v;
        }
    ...
    public static final class JobPushBack implements Job {
        ...
        public void setStartCoord(Position2D v) {
            this.start_coord = v;
        }
        ...
        public void setTargetCoord(Position2D v) {
            this.target_coord = v;
        }
    ...
    public static final class JobStampede implements Job {
        ...
        public void setSpell(SpellId v) {
            this.spell = v;
        }
    ...
    public static final class JobFlameThrower implements Job {
        ...
        public TickCount getDurationStepInit() {
            return duration_step_init;
        }

        public void setDurationStepInit(TickCount v) {
            this.duration_step_init = v;
        }

        public TickCount getDurationStepShutDown() {
            return duration_step_shut_down;
        }

        public void setDurationStepShutDown(TickCount v) {
            this.duration_step_shut_down = v;
        }
    ...
    public static final class JobConstruct implements Job {
        ...
        public TickCount getConstructionUpdateSteps() {
            return construction_update_steps;
        }

        public void setConstructionUpdateSteps(TickCount v) {
            this.construction_update_steps = v;
        }

        public TickCount getConstructionUpdateCountRemaining() {
            return construction_update_count_remaining;
        }

        public void setConstructionUpdateCountRemaining(TickCount v) {
            this.construction_update_count_remaining = v;
        }
    ...
    public static final class JobCrush implements Job {
        ...
        public void setCrushSteps(TickCount v) {
            this.crush_steps = v;
        }

        public TickCount getEntityUpdateSteps() {
            return entity_update_steps;
        }

        public void setEntityUpdateSteps(TickCount v) {
            this.entity_update_steps = v;
        }

        public TickCount getRemainingCrushSteps() {
            return remaining_crush_steps;
        }

        public void setRemainingCrushSteps(TickCount v) {
            this.remaining_crush_steps = v;
        }
    ...
    public static final class JobMountBarrierSquad implements Job {
        ...
        public EntityId getBarrierModule() {
            return barrier_module;
        }

        public void setBarrierModule(EntityId v) {
            this.barrier_module = v;
        }
    ...
    public static final class JobMountBarrier implements Job {
        ...
        public EntityId getCurrentBarrierModule() {
            return current_barrier_module;
        }

        public void setCurrentBarrierModule(EntityId v) {
            this.current_barrier_module = v;
        }

        public EntityId getGoalBarrierModule() {
            return goal_barrier_module;
        }

        public void setGoalBarrierModule(EntityId v) {
            this.goal_barrier_module = v;
        }
    ...
    public static final class JobModeChangeSquad implements Job {
        ...
        public void setNewMode(ModeId v) {
            this.new_mode = v;
        }

        public boolean getModeChangeDone() {
            return mode_change_done;
        }

        public void setModeChangeDone(boolean v) {
            this.mode_change_done = v;
        }
    ...
    public static final class JobSacrificeSquad implements Job {
        ...
        public void setTargetEntity(EntityId v) {
            this.target_entity = v;
        }
    ...
    public static final class JobChannel implements Job {
        ...
        public void setTargetSquadId(EntityId v) {
            this.target_squad_id = v;
        }

        public boolean getModeTargetWorld() {
            return mode_target_world;
        }

        public void setModeTargetWorld(boolean v) {
            this.mode_target_world = v;
        }
        ...
        public void setEntityId(EntityId v) {
            this.entity_id = v;
        }
        ...
        public SpellId getSpellIdOnTargetOnFinish() {
            return spell_id_on_target_on_finish;
        }

        public void setSpellIdOnTargetOnFinish(SpellId v) {
            this.spell_id_on_target_on_finish = v;
        }

        public SpellId getSpellIdOnTargetOnStart() {
            return spell_id_on_target_on_start;
        }

        public void setSpellIdOnTargetOnStart(SpellId v) {
            this.spell_id_on_target_on_start = v;
        }

        public TickCount getStepDurationUntilFinish() {
            return step_duration_until_finish;
        }

        public void setStepDurationUntilFinish(TickCount v) {
            this.step_duration_until_finish = v;
        }

        public int getTimingChannelStart() {
            return timing_channel_start;
        }

        public void setTimingChannelStart(int v) {
            this.timing_channel_start = v;
        }

        public int getTimingChannelLoop() {
            return timing_channel_loop;
        }

        public void setTimingChannelLoop(int v) {
            this.timing_channel_loop = v;
        }

        public int getTimingChannelEnd() {
            return timing_channel_end;
        }

        public void setTimingChannelEnd(int v) {
            this.timing_channel_end = v;
        }

        public float getAbortOnOutOfRangeSquared() {
            return abort_on_out_of_range_squared;
        }

        public void setAbortOnOutOfRangeSquared(float v) {
            this.abort_on_out_of_range_squared = v;
        }

        public boolean getAbortCheckFailed() {
            return abort_check_failed;
        }

        public void setAbortCheckFailed(boolean v) {
            this.abort_check_failed = v;
        }

        public boolean getOrientateToTarget() {
            return orientate_to_target;
        }

        public void setOrientateToTarget(boolean v) {
            this.orientate_to_target = v;
        }

        public TickCount getOrientateToTargetMaxStep() {
            return orientate_to_target_max_step;
        }

        public void setOrientateToTargetMaxStep(TickCount v) {
            this.orientate_to_target_max_step = v;
        }

        public boolean getAbortOnOwnerGetDamaged() {
            return abort_on_owner_get_damaged;
        }

        public void setAbortOnOwnerGetDamaged(boolean v) {
            this.abort_on_owner_get_damaged = v;
        }

        public boolean getAbortOnModeChange() {
            return abort_on_mode_change;
        }

        public void setAbortOnModeChange(boolean v) {
            this.abort_on_mode_change = v;
        }
        ...
        public JobHolder(Job v) {
            ...
            switch (v.getType()) {
                ...
                case JobType.Unknown:
                    ...
                    break;
                default:
                    throw new IllegalArgumentException("Unknown Job " + v.getType());
            }
        }
    ...
    public static class Entity {
        ...
        public void setJob(JobHolder v) {
            this.job = v;
        }
        ...
        public void setPlayerEntityId(EntityId v) {
            this.player_entity_id = v;
        }
    ...
    public static class TokenSlot {
        ...
        public void setColor(OrbColor v) {
            this.color = v;
        }
    ...
    public static class Squad {
        ...
        public void setCardId(CardId v) {
            this.card_id = v;
        }
        ...
        public void setResSquadId(SquadId v) {
            this.res_squad_id = v;
        }
        ...
        public void setBoundPower(float v) {
            this.bound_power = v;
        }
        ...
        public void setSquadSize(byte v) {
            this.squad_size = v;
        }

        public EntityId[] getFigures() {
            return figures;
        }

        public void setFigures(EntityId[] v) {
            this.figures = v;
        }
    ...
    public static class Figure {
        ...
        public void setSquadId(EntityId v) {
            this.squad_id = v;
        }
        ...
        public void setUnitSize(byte v) {
            this.unit_size = v;
        }
        ...
        public void setMoveMode(byte v) {
            this.move_mode = v;
        }
    ...
    public static class Building {
        ...
        public void setBuildingId(BuildingId v) {
            this.building_id = v;
        }
        ...
        public void setPowerCost(float v) {
            this.power_cost = v;
        }
    ...
    public static class BarrierModule {
        ...
        public void setFreeSlots(byte v) {
            this.free_slots = v;
        }
        ...
        public void setWalkable(boolean v) {
            this.walkable = v;
        }
    ...
    public static final class CommandBuildHouse implements Command {
        ...
        public void setCardPosition(byte v) {
            this.card_position = v;
        }
    ...
    public static final class CommandCastSpellGod implements Command {
        ...
        public void setTarget(SingleTargetHolder v) {
            this.target = v;
        }
    ...
    public static final class CommandCastSpellGodMulti implements Command {
        ...
        public void setXy1(Position2D v) {
            this.xy1 = v;
        }
        ...
        public void setXy2(Position2D v) {
            this.xy2 = v;
        }
    ...
    public static final class CommandProduceSquadOnBarrier implements Command {
        ...
        public EntityId getBarrierToMount() {
            return barrier_to_mount;
        }

        public void setBarrierToMount(EntityId v) {
            this.barrier_to_mount = v;
        }
    ...
    public static final class CommandCastSpellEntity implements Command {
        ...
        public void setEntity(EntityId v) {
            this.entity = v;
        }
    ...
    public static final class CommandBarrierGateToggle implements Command {
        ...
        public void setBarrierId(EntityId v) {
            this.barrier_id = v;
        }
    ...
    public static final class CommandBarrierBuild implements Command {
        ...
        public boolean getInvertedDirection() {
            return inverted_direction;
        }

        public void setInvertedDirection(boolean v) {
            this.inverted_direction = v;
        }
    ...
    public static final class CommandRepairBuilding implements Command {
        ...
        public void setBuildingId(EntityId v) {
            this.building_id = v;
        }
    ...
    public static final class CommandGroupAttack implements Command {
        ...
        public EntityId[] getSquads() {
            return squads;
        }

        public void setSquads(EntityId[] v) {
            this.squads = v;
        }
        ...
        public boolean getForceAttack() {
            return force_attack;
        }

        public void setForceAttack(boolean v) {
            this.force_attack = v;
        }
    ...
    public static final class CommandGroupGoto implements Command {
        ...
        public void setPositions(Position2D[] v) {
            this.positions = v;
        }
    ...
    public static final class CommandModeChange implements Command {
        ...
        public void setNewModeId(ModeId v) {
            this.new_mode_id = v;
        }
    ...
    public static final class CommandPowerSlotBuild implements Command {
        ...
        public void setSlotId(EntityId v) {
            this.slot_id = v;
        }
    ...
    public static final class CommandTokenSlotBuild implements Command {
        ...
        public void setColor(CreateOrbColor v) {
            this.color = v;
        }
        ...
        public CommandHolder(Command v) {
            ...
            switch (v.getType()) {
                ...
                case CommandType.WhisperToMaster:
                    ...
                    break;
                default:
                    throw new IllegalArgumentException("Unknown Command " + v.getType());
            }
        }
    ...
    public static class PlayerCommand {
        ...
        public void setPlayer(EntityId v) {
            this.player = v;
        }
        ...
        public void setCommand(CommandHolder v) {
            this.command = v;
        }
    ...
    public static final class CommandRejectionReasonCardRejected implements CommandRejectionReason {
        ...
        public void setReason(WhyCanNotPlayCardThere v) {
            this.reason = v;
        }

        public int[] getFailedCardConditions() {
            return failed_card_conditions;
        }

        public void setFailedCardConditions(int[] v) {
            this.failed_card_conditions = v;
        }
    ...
    public static final class CommandRejectionReasonNotEnoughPower implements CommandRejectionReason {
        ...
        public void setPlayerPower(float v) {
            this.player_power = v;
        }
        ...
        public void setRequired(short v) {
            this.required = v;
        }
    ...
    public static final class CommandRejectionReasonCanNotCast implements CommandRejectionReason {
        ...
        public int[] getFailedSpellConditions() {
            return failed_spell_conditions;
        }

        public void setFailedSpellConditions(int[] v) {
            this.failed_spell_conditions = v;
        }
        ...
        public CommandRejectionReasonHolder(CommandRejectionReason v) {
            ...
            switch (v.getType()) {
                ...
                case CommandRejectionReasonType.InvalidCard:
                    ...
                    break;
                default:
                    throw new IllegalArgumentException("Unknown CommandRejectionReason " + v.getType());
            }
        }
    ...
    public static class RejectedCommand {
        ...
        public void setReason(CommandRejectionReasonHolder v) {
            this.reason = v;
        }
    ...
    public static class MapEntities {
        ...
        public void setProjectiles(Projectile[] v) {
            this.projectiles = v;
        }

        public PowerSlot[] getPowerSlots() {
            return power_slots;
        }

        public void setPowerSlots(PowerSlot[] v) {
            this.power_slots = v;
        }

        public TokenSlot[] getTokenSlots() {
            return token_slots;
        }

        public void setTokenSlots(TokenSlot[] v) {
            this.token_slots = v;
        }

        public AbilityWorldObject[] getAbilityWorldObjects() {
            return ability_world_objects;
        }

        public void setAbilityWorldObjects(AbilityWorldObject[] v) {
            this.ability_world_objects = v;
        }
        ...
        public void setFigures(Figure[] v) {
            this.figures = v;
        }
        ...
        public void setBuildings(Building[] v) {
            this.buildings = v;
        }

        public BarrierSet[] getBarrierSets() {
            return barrier_sets;
        }

        public void setBarrierSets(BarrierSet[] v) {
            this.barrier_sets = v;
        }

        public BarrierModule[] getBarrierModules() {
            return barrier_modules;
        }

        public void setBarrierModules(BarrierModule[] v) {
            this.barrier_modules = v;
        }
    ...
    public static class GameStartState {
        ...
        public void setYourPlayerId(EntityId v) {
            this.your_player_id = v;
        }
        ...
        public void setPlayers(MatchPlayer[] v) {
            this.players = v;
        }
        ...
        public void setEntities(MapEntities v) {
            this.entities = v;
        }
    ...
    public static class GameState {
        ...
        public void setCurrentTick(Tick v) {
            this.current_tick = v;
        }
        ...
        public void setCommands(PlayerCommand[] v) {
            this.commands = v;
        }

        public RejectedCommand[] getRejectedCommands() {
            return rejected_commands;
        }

        public void setRejectedCommands(RejectedCommand[] v) {
            this.rejected_commands = v;
        }
        ...
        public void setPlayers(PlayerEntity[] v) {
            this.players = v;
        }
    ...
    public static class Prepare {
        ...
        public void setMapInfo(MapInfo v) {
            this.map_info = v;
        }
